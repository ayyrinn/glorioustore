    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                    <a href="{{ route('orders.create') }}" class="btn btn-primary add-list">New Order</a>
                ...
                <table class="table mb-0">
                    <thead class="bg-white text-uppercase">
                        <tr class="ligth ligth-data">
                            <th>No.</th>
                            <th>ID</th>
                            <th>@sortablelink('supname', 'supplier')</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="btn btn-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Details" href="{{ route('order.details', $order->orderid) }}">
                                        Details
                                    </a>
                                    {{-- <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"
                                        href="{{ route('order.edit', $order->orderid) }}""><i class="ri-pencil-line mr-0"></i>
                                    </a> --}}
                                </div>
                            </td>
                        </tr>
