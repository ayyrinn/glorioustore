                    ...
                    <ul class="list-inline p-0 mb-0">
                        ...
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" id="DOB" value="{{ $employee->DOB }}" readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                        ...
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $employee->role }}" readonly>
                                </div>
                            </div>
                        </li>
                        {{-- Role --}}
