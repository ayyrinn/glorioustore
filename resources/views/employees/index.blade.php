    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                <div>
                    1 - {{ $employees->count() }} dari {{ $employees->total() }} hasil
                </div>
                <div class="d-flex align-items-center">
                    <div>
                        1 dari {{ $employees->lastPage() }} halaman
                    </div>
                    <div class="ml-3">
                        <a href="{{ $employees->previousPageUrl() ?? '#' }}" class="btn btn-danger-{{ $employees->previousPageUrl() ? 'primary' : 'secondary' }}">Sebelumnya</a>
                        <a href="{{ $employees->nextPageUrl() ?? '#' }}" class="btn btn-danger-{{ $employees->nextPageUrl() ? 'primary' : 'secondary' }} ml-2">Selanjutnya</a>
                    </div>
                </div>
            </div>
        </div>
